...
const char *spcmd2[] = {TERMINAL, "-n", "spmusic", "-c", "spmusic", "-g", "120x25", "-e", "rmpc", NULL};
...
const char *spcmd5[] = {TERMINAL, "-n", "spmarks", "-c", "spmarks", "-g", "110x25", "-e", SHELL, "-c", "gms", NULL };
const char *spcmd6[] = {TERMINAL, "-n", "spcalc", "-f", "MapleMono NF:size=16", "-g", "28x8", "-e", "bc", "-lq", NULL };
const char *spcmd7[] = {TERMINAL, "-n", "spai", "-c", "spai", "-g", "130x30", "-e", SHELL, "-ic", "ollama.sh", NULL };
const char *spcmd8[] = {TERMINAL, "-n", "spsf", "-g", "95x22", "-e", SHELL, "-c", "shf", NULL };
const char *spcmd9[] = {TERMINAL, "-n", "spsf", "-g", "95x22", "-e", SHELL, "-c", "shf --send", NULL };
...
const char *spcmd15[] = {TERMINAL, "-n", "spmixer", "-c", "spmixer", "-g", "120x25", "-e", "ncpamixer", NULL};
static Sp scratchpads[] = {
    ...
    {"spai",        spcmd7},    // chatbot
    {"spsf",        spcmd8},    // shf with `nnn+dragondrop`
    {"spsf",        spcmd9},    // shf with `localsend`
    ...
    {"spmixer",     spcmd15},   // ncurses PulseAudio Mixer
};
